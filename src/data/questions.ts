...
export const questions: Question[] = [
  ...
  },
  {
    ...
    choices: [
      "To make PDA derivations unique across different seed schemas",
      "To find an off-curve derivation for the seed set",
      "To let the runtime reconstruct signing authority without stored keys",
      "To add entropy so the derived address is unpredictable to clients",
    ],
    answerIndex: 1,
    explanation:
  ...
  },
  {
    ...
    choices: [
      "A single PDA per program that stores all user state",
      "A PDA per user or per position",
      "One PDA per epoch that rotates to reduce hot writes",
  ...
  },
  {
    ...
    choices: [
      "CPI may add signer privileges if the callee owns the account",
      "CPI passes along equal or lower signer/writable privileges",
      "CPI may upgrade read-only accounts to writable if the callee owns them",
      "CPI may re-enable signer privileges that were dropped in the outer message",
    ],
    answerIndex: 1,
    explanation:
  ...
  },
  {
    ...
    choices: [
      "The system program plus a writable programdata account and upgrade authority",
      "The BPF Loader Upgradeable program",
      "The legacy BPF Loader with a programdata account and authority",
      "Feature gates that allow program bytes to change on validator restart",
    ],
    answerIndex: 1,
    explanation:
  ...
  },
  {
    ...
    choices: [
      "To auto-generate account metas and PDA derivations from the ABI",
      "To ensure typed instruction encoding/decoding and layouts",
      "To manage blockhashes and fee payer selection automatically",
      "To avoid passing accounts by fetching them via RPC at runtime",
    ],
    answerIndex: 1,
    explanation:
  ...
  },
  {
    ...
    choices: [
      "A single program state account with per-user records inside",
      "Sharded state with one account per user or per market",
      "One PDA per instruction type reused across users",
      "A rotating PDA per epoch to spread write load",
    ],
    answerIndex: 1,
    explanation:
  ...
  },
  {
    ...
    choices: [
      "Take read locks that still conflict with other read-only locks across transactions",
      "Use shared/read locks, allowing concurrent readers across transactions",
      "Take no locks and are revalidated at commit time for conflicts",
      "Are treated as writable if any CPI in the transaction requests them",
    ],
    answerIndex: 1,
    explanation:
  ...
  },
  {
    ...
    choices: [
      "To invoke other programs without CPI overhead or account passing",
      "To access runtime-provided functionality like hashing or sysvars",
      "To allocate more heap or stack than the program limit",
      "To open network sockets from within the program",
    ],
    answerIndex: 1,
    explanation:
  ...
  },
  {
    ...
    choices: [
      "From the first signer listed in the message header",
      "From the fee payer specified in the message header",
      "Split across all writable accounts in the message",
      "Charged to the leader and rebated from priority fees",
    ],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: [
      ...
      "To compress account metas by moving them into a sysvar",
  ...
  },
  {
    ...
    choices: [
      "By storing account metas on-chain and referencing them by index",
      "By storing addresses on-chain and referencing them by index",
      "By compressing pubkeys with a shortvec dictionary",
  ...
  },
  {
    ...
    choices: [
      "A PoH tick interval used to derive hashes and timestamps",
      "A scheduled leader window in which a leader produces entries/blocks",
      "A vote lockout period that defines finality depth",
      "A finalized block at a given height",
    ],
    answerIndex: 1,
    explanation:
  ...
  },
  {
    ...
    choices: [
      "A finality gadget built on vote lockouts",
      "A verifiable ordering/clock primitive used to sequence events efficiently",
      "A slashing system for equivocation and double-voting",
      "A randomness beacon that selects leaders per slot",
    ],
    answerIndex: 1,
    explanation:
  ...
  },
  {
    ...
    choices: [
      "They store stake delegation and lockup state for delegators",
      "They cast votes on forks and earn rewards",
      "They store validator identity and contact info used for gossip",
  ...
  },
  {
    ...
    choices: [
      ...
      "Recent transaction throughput per validator",
  ...
  },
  {
    ...
    choices: [
      ...
      "Distributing shreds and handling repair to peers",
      "Computing leader schedule and stake weights",
    ],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: [
      "Distribute shreds and repair data to peers",
      "Propagate cluster metadata (peers, votes, leader schedule info, etc.)",
      "Forward client transactions directly to the current leader",
      "Stream account snapshots for fast catchup",
    ],
    answerIndex: 1,
    explanation:
  ...
  },
  {
    ...
    choices: [
      "Forward client transactions into the leader pipeline",
      "Efficiently broadcast blocks via shreds",
      "Propagate cluster metadata such as peers and votes",
      "Replay blocks to update state",
    ],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: [
      ...
      "Request additional account fields in the response",
      "Automatically retry until finalized",
    ],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: [
      ...
      "When you need to backfill large historical ranges",
      "When you need a single one-off read",
    ],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: [
      "Always the state at the highest rooted slot",
      "Dependent on the commitment level of the request",
      "Guaranteed to be final after one confirmation",
  ...
  },
  {
    ...
    choices: [
      "When a SIMD is merged and shipped in a validator release",
      "When a supermajority of validators upgrade to that release",
      "When the feature gate is activated on-chain",
      "When the feature is enabled on testnet and scheduled for mainnet",
    ],
    answerIndex: 2,
    explanation:
  ...
  },
  {
    ...
    choices: [
      "To allow mixed versions to run without any fork risk",
      "To activate changes safely and sequentially",
      "To enable program upgrades without an upgrade authority",
      "To enforce account ownership checks at runtime",
    ],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: [
      "Logs are part of consensus and must be replayed, so they are canonical",
      "Logs are hints for debugging/UX, not canonical on-chain state",
      "Logs are derived from account data after execution, so they are always authoritative",
      "Logs are stored in a dedicated on-chain account for each program",
    ],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: [
      ...
      "Order only affects compute budgeting, not state",
      "Order only affects CPI privilege propagation, not state",
    ],
    answerIndex: 1,
    explanation:
  ...
  },
  {
    ...
    choices: [
      "Derive it from seeds without the caller passing it",
      "Receive it from the caller as an account input",
      "Fetch it from RPC during execution",
      "Load it implicitly from a sysvar or programdata",
    ],
    answerIndex: 1,
    explanation:
  ...
  },
  {
    ...
    choices: [
      "So fees and compute usage are identical for all clients",
      "So all validators reach the same state",
      "So leaders can reorder transactions without changing results",
      "So account locks can be inferred without reading accounts",
    ],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: [
      "Because signatures are exclusive per account per slot",
      "Because it would cause write-write conflicts",
      "Because PoH imposes a total order on account writes",
      "Because stake-weighted QoS serializes writes from one fee payer",
    ],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: [
      "They don’t support the versioned transaction format or ALTs",
      "They reject any message that references address lookup tables",
      "They require the fee payer to be the first writable account",
      "They disallow v0 messages with non-default compute budgets",
    ],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: [
      "The runtime enforces a fixed serialization format like Borsh",
      "Arbitrary bytes interpreted by the program",
      "Instruction data must begin with a runtime-defined opcode prefix",
      "Instruction data is derived from account metas instead of client input",
    ],
    answerIndex: 1,
    explanation:
  ...
  },
  {
    ...
    choices: [
      "Reconstructing canonical state because logs are replayed",
      "Debugging and UX hints",
      "Submitting validator votes and lockouts",
      "Collecting program fees and revenue records",
    ],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: [
      "It changes the recent blockhash used for signature verification",
      "It increases compute and account requirements",
      "It resets the compute budget to default for subsequent instructions",
      "It forces the transaction to be re-signed after simulation",
    ],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: [
      "Programs accept accounts without verifying expected addresses or owners",
      "Programs allow read-only accounts in the instruction",
      "Programs derive PDAs internally instead of using passed accounts",
      "Programs only check signer bits and skip owner checks",
    ],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: [
      "To satisfy rent-exempt requirements for larger accounts",
      "To avoid panics and ensure correct layout",
      "To align data to 8-byte boundaries for BPF",
